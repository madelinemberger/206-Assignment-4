...
wilcox.test(mpas_2012$IVEE,mpas_2017$IVEE)

#Result: Ranks are not equal...this is not the same as the t.test 
...
wilcox.test(mpas_2012$NAPL,mpas_2017$NAPL)
...
#Experiment: try Mann Whitney U

wilcox.test(nonmpas_2012$AQUE,nonmpas_2017$AQUE)

#Result: There is no significant differnce in rank 
